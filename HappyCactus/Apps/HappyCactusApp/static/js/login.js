window.addEventListener('load', () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        if (validaCampos()) {
            if (usuario.value == localStorage.getItem('usuario') && SHA1(pass.value) == localStorage.getItem('pass')) {
                form.submit();
            ...
            console.log(SHA1(pass.value))
            validaFalla(usuario, 'Usuario o contraseña incorrectos'),
            validaFalla(pass,'')
            usuario.value = ''
            pass.value = ''
            }
    ...
    const validaCampos = () => {
        ...
        if (!passValor) {
            validaFalla(pass, 'El password no debe estar en blanco')
        }
        else {
            validaOk(pass)
        }
